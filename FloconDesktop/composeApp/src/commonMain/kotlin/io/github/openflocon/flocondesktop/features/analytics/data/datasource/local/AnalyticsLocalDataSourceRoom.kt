...
class AnalyticsLocalDataSourceRoom(
    ...
    override suspend fun insert(deviceIdAndPackageName: DeviceIdAndPackageName, items: List<AnalyticsItemDomainModel>) {
    ...
    override fun observe(deviceIdAndPackageName: DeviceIdAndPackageName, analyticsTableId: AnalyticsTableId): Flow<List<AnalyticsItemDomainModel>> =
    ...
    override suspend fun delete(deviceIdAndPackageName: DeviceIdAndPackageName, analyticsId: AnalyticsIdentifierDomainModel) {
    ...
    override suspend fun getDeviceAnalytics(deviceIdAndPackageName: DeviceIdAndPackageName): List<AnalyticsIdentifierDomainModel> =
