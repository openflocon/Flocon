...
fun listToRemote(mocks: List<MockNetworkResponseDomainModel>): List<MockNetworkResponseDataModel> = mocks.map { toRemote(it) }

fun toRemote(mock: MockNetworkResponseDomainModel) : MockNetworkResponseDataModel {
