...
class GetTableColumnsUseCase(
    ...
    suspend operator fun invoke(
        ...
        databaseId: String
    ): Either<Throwable, Unit> = databaseRepository.executeQuery(
    ...
    private fun extractTableColumns(result: DatabaseExecuteSqlResponseDomainModel): List<DatabaseTableDomainModel.Column> = (result as? DatabaseExecuteSqlResponseDomainModel.Select)?.let {
