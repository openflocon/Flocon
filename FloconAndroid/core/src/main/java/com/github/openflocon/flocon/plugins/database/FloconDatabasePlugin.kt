package com.github.openflocon.flocon.plugins.database
...
import com.github.openflocon.flocon.plugins.database.model.fromdevice.DatabaseExecuteSqlResponse
import com.github.openflocon.flocon.plugins.database.model.fromdevice.DeviceDataBaseDataModel
import com.github.openflocon.flocon.plugins.database.model.fromdevice.QueryResultDataModel
import com.github.openflocon.flocon.plugins.database.model.fromdevice.listDeviceDataBaseDataModelToJson
import com.github.openflocon.flocon.plugins.database.model.fromdevice.toJson
import com.github.openflocon.flocon.plugins.database.model.todevice.DatabaseQueryMessage
import java.io.File
        ...
        directory.listFiles()?.forEach { file ->
            if (file.isDirectory) {
                ...
                if (file.isFile &&
                    ...
                    // You might want to add more robust checks here, like magic numbers,
                    // but file extension is a common first filter.
                    && !file.name.contains(".") // Often, actual DB files don't have extensions, or if they do, it's specific like .db
                ) {
                    foundDatabases.add(
